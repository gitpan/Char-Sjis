...
Latin-1 ‚ğˆµ‚¢‚Ü‚¹‚ñB‚»‚Ì‚½‚ß UTF8 ƒtƒ‰ƒO‚Í‚ ‚è‚Ü‚¹‚ñB
...
=item * JPerl ‚Ì‚æ‚¤‚ÉƒVƒtƒgJIS‚ğ‚»‚Ì‚Ü‚Üˆµ‚¢AUTF8ƒtƒ‰ƒO‚ª‚È‚¢
...
‰ß‹‚Ìperl‚Æ‚ÌŒİŠ·«‚ğ•Û‚Â‚½‚ß‚É•¶šƒNƒ‰ƒX‚ÍˆÈ‰º‚Ì‚æ‚¤‚ÉÄ’è‹`‚³‚ê‚Ä‚¢‚Ü‚·B
  ...
  ---------------------------------------------------------------------------
   .            (?:[\x81-\x9F\xE0-\xFC][\x00-\xFF]|[^\x81-\x9F\xE0-\xFC\x0A])
                (?:[\x81-\x9F\xE0-\xFC][\x00-\xFF]|[^\x81-\x9F\xE0-\xFC])     (/s Cüq‚ ‚è)
  \d            [0-9]
...
“¯—l‚É POSIX ƒXƒ^ƒCƒ‹‚Ì•¶šƒNƒ‰ƒX‚àÄ’è‹`‚³‚ê‚Ä‚¢‚Ü‚·B
  ...
  [:^lower:]    (?:[\x81-\x9F\xE0-\xFC][\x00-\xFF]|[^\x81-\x9F\xE0-\xFC\x61-\x7A])
                (?:[\x81-\x9F\xE0-\xFC][\x00-\xFF]|[^\x81-\x9F\xE0-\xFC])           (/i Cüq‚ ‚è)
...
=item * “Áê•Ï” $` ‚Æ $& ‚Í‹@”\‚µ‚Ü‚¹‚ñ
 ...
 ‚ ‚é‚¢‚ÍˆÈ‰º‚Ì•û–@‚à‚ ‚è‚Ü‚·B
  ...
  -------------------------------------------------
  $`     substr(‘ÎÛ•¶š—ñ, 0, $-[0])
  $&     substr(‘ÎÛ•¶š—ñ, $-[0], $+[0], - $-[0])
  $'     substr(‘ÎÛ•¶š—ñ, $+[0])
  -------------------------------------------------
  uÚà ³‹K•\Œ» ‘æ2”Å P.349 7.9.3.4 ƒ}ƒbƒ`‘OƒRƒs[‚ğ‰ñ”ğ‚·‚év‚æ‚è

=item * ³‹K•\Œ»‚ğ“K—p‚·‚é•¶š—ñ‚Ì’·‚³‚ÌãŒÀ

    ã‹L‚Ì‚Æ‚¨‚èAƒGƒXƒP[ƒvŒã‚Ì³‹K•\Œ»‚É‚Íƒ}ƒ‹ƒ`ƒoƒCƒgƒAƒ“ƒJ[ƒŠƒ“ƒOˆ—‚Ì‚½
    ‚ß‚Ì‹Lq‚ª’Ç‰Á‚³‚ê‚Ü‚·‚ªA‚»‚Ì’†‚ÉŠÜ‚Ü‚ê‚é \G ‚Ì§–ñ‚ğó‚¯‚Ü‚·B
    perl5.006, perl5.008, perl5.010, perl5.012, perl5.014 ‚ÅÀs‚µ‚½ê‡A‘ÎÛ
    •¶š—ñ‚Ì32,767ƒoƒCƒg‚ğ’´‚¦‚éˆÊ’u‚Å‚Ìƒ}ƒbƒ`‚·‚×‚«‚Æ‚±‚ë‚Åƒ}ƒbƒ`‚µ‚Ü‚¹‚ñB
    ‚È‚¨‚©‚ÂA‚»‚ÌÛ‚ÉƒGƒ‰[‚àŒx‚ào—Í‚³‚ê‚Ü‚¹‚ñB
...
=item * ƒS[ƒ‹4
    ...
    Œ¾Œê‚ª•ªŠò‚·‚é‚±‚Æ‚É‚È‚èAƒRƒ~ƒ…ƒjƒeƒB‚Ík¬‚ğ—]‹V‚È‚­‚³‚ê‚Ü‚µ‚½B
