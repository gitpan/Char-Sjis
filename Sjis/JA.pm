...
ƒXƒNƒŠƒvƒg‚ÌŠÔ‚ÉˆÊ’u‚·‚éƒ~ƒhƒ‹ƒEƒFƒA‚Å‚·B

Perl ‚ÍAƒeƒLƒXƒgˆ—‚ª90%A‚»‚êˆÈŠO‚Ìˆ—‚ª10%‚Å\¬‚³‚ê‚é–â‘è‚ÉŒü‚¯‚ÄÅ“K‰»‚³
‚ê‚Ä‚¢‚Ü‚·B‚Å‚à‚±‚Ì "ƒeƒLƒXƒg" ‚Æ‚Í US-ASCII ‚Ì‚±‚Æ‚ÅAShiftJIS ‚Í "‚»‚êˆÈŠO
‚Ìˆ—" ‚ÉŠÜ‚Ü‚ê‚Ü‚·B

‚ª‚Á‚©‚è‚·‚é•K—v‚Í‚ ‚è‚Ü‚¹‚ñB

Perl3 ˆÈ~‚Ì•¶š—ñ‚ÍƒoƒCƒiƒŠƒf[ƒ^‚ğˆµ‚¤‚±‚Æ‚ª‚Å‚«‚Ü‚·B‚Â‚Ü‚è Perl3 ˆÈ~‚Ì•¶š
—ñ‚Í ShiftJIS ‚ğˆµ‚¤‚±‚Æ‚ª‚Å‚«‚é‚Ì‚Å‚·B

Perl ‚ÍŠÈ’P‚È‚±‚Æ‚ÍŠÈ’P‚ÉA“ï‚µ‚¢‚±‚Æ‚à‚»‚ê‚È‚è‚Éo—ˆ‚éŒ¾Œê‚Æ‚µ‚ÄİŒv‚³‚ê‚Ü‚µ
‚½BSjisƒ\ƒtƒgƒEƒFƒA‚ÍŠÈ’P‚È‚±‚Æ‚ğŠÈ’P‚És‚¤‚æ‚¤‚É‚·‚é‚½‚ß‚ÌƒvƒƒOƒ‰ƒ€‚Å‚·B
...
=item * JPerl ‚Ì‚æ‚¤‚ÉShiftJIS‚ğ‚»‚Ì‚Ü‚Üˆµ‚¢AUTF8ƒtƒ‰ƒO‚ğg‚í‚È‚¢
...
‚±‚Ìƒ\ƒtƒgƒEƒFƒA‚Æ‚»‚Ì–¢—ˆ‚É‚Â‚¢‚Äl‚¦‚é‚Æ‹¹‚ª‚Ç‚«‚Ç‚«‚µ‚Ü‚·B‚İ‚È‚³‚ñ‚¾‚Á‚Ä‚»‚¤
‚Å‚µ‚å‚¤H
...
=item * Sjis::index
    ...
    ‚±‚ê‚Ü‚Å’Ê‚èA‚±‚Ì‹@”\‚Í³‹K•\Œ»‚ÅÀŒ»‚Å‚«‚Ü‚·B‚¾‚©‚ç‚±‚ÌŠÖ”‚ğ’m‚ç‚È‚­‚Ä‚à–â
    ‘è‚Í‚È‚¢‚Å‚µ‚å‚¤B
...
=item * ³‹K•\Œ»‚ğ“K—p‚·‚é•¶š—ñ‚Ì’·‚³‚ÌãŒÀ
    ...
    ‚¯‚Ü‚·Bperl5.006, perl5.008, perl5.010, perl5.012, perl5.014, perl5.016 ‚Å
    Às‚µ‚½ê‡A‘ÎÛ•¶š—ñ‚Ì32,767ƒoƒCƒg‚ğ’´‚¦‚éˆÊ’u‚Å‚Ìƒ}ƒbƒ`‚·‚×‚«‚Æ‚±‚ë‚Å
    ƒ}ƒbƒ`‚µ‚Ü‚¹‚ñB‚È‚¨‚©‚ÂA‚»‚ÌÛ‚ÉƒGƒ‰[‚àŒx‚ào—Í‚³‚ê‚Ü‚¹‚ñB
