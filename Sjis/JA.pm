...
=item * Sjis::index
    ...
    •¶š’PˆÊ‚Å”‚¦‚Ä•Ô‚µ‚Ü‚·B$start ‚ªw’è‚³‚ê‚Ä‚¢‚éê‡A$string ‚Ìæ“ª‚©‚ç $start
...
=item * Sjis::rindex
    ...
    $position ‚É‚æ‚Á‚ÄA’l‚Æ‚µ‚Ä•Ô‚·‚±‚Æ‚ª‹–‚³‚ê‚éAÅ‚à‰E‚æ‚è‚ÌˆÊ’u‚ğw’è‚·‚é‚±‚Æ
...
=item * CORE::index
    ...
    •Ô‚µ‚Ü‚·B$start ‚ªw’è‚³‚ê‚Ä‚¢‚éê‡A$string ‚Ìæ“ª‚©‚ç $start ƒoƒCƒg•ªƒXƒLƒb
...
‚ğ——R‚É‚µ‚ÄˆÈ‰º‚Ì•ûX‚Ö‚ÌŠ´Ó‚ÍÈ—ª‚·‚é‚í‚¯‚É‚Í‚¢‚©‚È‚¢‚Å‚µ‚å‚¤B
 ...
 Å‘å‚Ì—˜“_‚Í‚¢‚í‚ä‚é”¼ŠpƒJƒ^ƒJƒi‚Æ‹¤‘¶‚Å‚«‚é‚±‚Æ‚Å‚·B‰ß‹‚Ì‘Y‚ğŒ»İ‚ÉŒp³‚Å‚«‚é
 ‚Æ‚¢‚¤‚±‚Æ‚ÍAŒ»İ‚Ì‘Y‚ğ–¢—ˆ‚ÖŒp³‚Å‚«‚é‚±‚Æ‚ğ¦´‚µ‚Ä‚¢‚Ü‚·B
 ...
 u“ú–{Œêî•ñˆ—v‚ğ“Ç‚ñ‚Å•¶šW‡‹KŠi‚Æ•„†‰»•û®‚ğŠw‚ÑA•¶š‰»‚¯‚É‚Â‚¢‚Ä—‰ğ‚ª[
 ‚Ü‚è‚Ü‚µ‚½B•¶š‰»‚¯‚ÌŒ´ˆö‚Ì‚Ğ‚Æ‚Â‚Æ‚µ‚Äu—˜—pÒ‚ÌˆÓv‚ÆˆÙ‚È‚éA•„†‰»•û®‚Ì•ÏŠ·v
 ‚ª‹“‚°‚ç‚ê‚Ü‚·B‚»‚ê‚ğ–h‚®‚½‚ß‚ÉA‚±‚Ìƒ\ƒtƒgƒEƒFƒA‚Í•„†‰»•û®‚ğ•ÏŠ·‚¹‚¸‚Éî•ñˆ—
 ‚ğs‚¢‚Ü‚·B
 ...
 ‚­‹³‚¦‚Ä‚à‚ç‚¢‚Ü‚µ‚½B¡“x Ruby ”Å‚ğì‚è‚Ü‚·‚Ì‚Å‚æ‚ë‚µ‚­‚¨Šè‚¢‚µ‚Ü‚·B
