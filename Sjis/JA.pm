...
=head1 ‰‚ß‚Ä‚ÌJPerl
  ...
  œ ˆÈ‰º‚Íƒ_ƒ~[ŠÖ”‚Æ‚µ‚Ä—pˆÓ‚³‚ê‚Ä‚¢‚é
      utf8::upgrade(...);
      utf8::downgrade(...);
      utf8::encode(...);
      utf8::decode(...);
...
=item * ƒtƒ@ƒCƒ‹–¼ƒOƒƒrƒ“ƒO
    ...
    ‚±‚ÌŠÖ”‚ÍA$string‚Ì’l‚É‘Î‚µ‚ÄADOS•—ƒVƒFƒ‹‚Æ“¯‚¶‚æ‚¤‚Èƒtƒ@ƒCƒ‹–¼“WŠJ‚ğs‚Á‚Ä
    “¾‚ç‚ê‚½Œ‹‰Ê‚ğ•Ô‚µ‚Ü‚·B$string ‚ªÈ—ª‚³‚ê‚½‚Æ‚«‚Í‘ã‚í‚è‚É $_ ‚ªg‚í‚ê‚Ü‚·B
    ‚±‚ÌŠÖ”‚Í Sjisƒ\ƒtƒgƒEƒFƒA“à•”‚Å <*> ‚¨‚æ‚Ñ glob ‰‰Zq‚ğÀ‘•‚µ‚Ä‚¢‚éŠÖ”‚Å‚·B
    MSWin32ŠÂ‹«‚É‚Ä $string ‚ª chr(0x5c) ‚ÅI—¹‚µ‚Ä‚¢‚éê‡‚Å‚à“®ì‚µ‚Ü‚·B

    g‚¢‚â‚·‚­‚·‚é‚½‚ß‚É globŠÖ”‚ÍAUNIX•—‚Å‚Í‚È‚­ADOS•—‚Ì“WŠJ‚ğs‚¤‚æ‚¤‚É‚È‚Á‚Ä
    ‚¢‚Ü‚·BƒAƒXƒ^ƒŠƒXƒN("*")‚ÍA”CˆÓ‚Ì•¶š‚ğ”CˆÓŒÂ(0ŒÂ‚Å‚à‚æ‚¢)•À‚×‚½‚à‚Ì‚Éƒ}ƒbƒ`
    ...
    ƒNƒH[ƒg‚ÅˆÍ‚Ş•K—v‚ª‚ ‚è‚Ü‚·B‚È‚º‚È‚çAglob ŠÖ”‚ÍA‹ó”’•¶š‚ğ“Á•Êˆµ‚¢‚µ‚Ä•¡”
