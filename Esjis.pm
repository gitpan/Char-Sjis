...
This module is a run-time routines of the Sjis.pm.
Because the Sjis.pm automatically uses this module, you need not use directly.
...
=item Chop string
  ...
  character chopped. The Esjis::chop function is used primary to remove the newline
...
=item Reverse index string
  ...
  This function works just like Esjis::index except that it returns the byte
...
=item Lower case string
  ...
  You can use the Esjis::fc function for case-insensitive comparisons via Sjis
  software.
...
=item Fold case string
  ...
  New to Sjis software, this function returns the full Unicode-like casefold of
...
=item File test function Esjis::X
...
=item Filename expansion (globbing)
  ...
  The Esjis::glob function grandfathers the use of whitespace to separate multiple
...
=item Statistics about file
  ...
  the last Esjis::stat, Esjis::lstat, or Esjis::stat-based file test function
