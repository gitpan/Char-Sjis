...
BEGIN {
    ...
    if ($^O =~ /\A (?: MSWin32 | NetWare | symbian | dos ) \z/oxms) {
        $PERL5LIB =~ s{[^\x81-\x9F\xE0-\xFC/]*$}{Char::Sjis};
    }
...
=item Make character
  ...
  set. For example, Char::Esjis::chr(65) is "A" in either ASCII or ShiftJIS, not Unicode,
  and Char::Esjis::chr(0x82a0) is a ShiftJIS HIRAGANA LETTER A. For the reverse of
  Char::Esjis::chr, use Char::Sjis::ord.
