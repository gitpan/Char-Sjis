...
This module is a run-time routines of the Char::Sjis module.
Because the Char::Sjis module automatically uses this module, you need not use directly.
