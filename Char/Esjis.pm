...
sub Char::Esjis::filetest {
    ...
    unless (CORE::eval qq{Char::Esjis::$filetest(\$file)}) {
        return '';
    }
...
sub Char::Esjis::filetest_ {
    ...
    unless (CORE::eval qq{Char::Esjis::${filetest}_}) {
        return '';
    }
    for my $filetest (CORE::reverse @_) {
        unless (CORE::eval qq{ $filetest _ }) {
...
sub Char::Sjis::escape(;$) {
    ...
    while (not /\G \z/oxgc) { # member
        $e_script .= Char::Sjis::escape_token();
    }
...
# subroutines of package Char::Esjis
    ...
    elsif (/\G \b Char::Sjis::eval       (?= \s* \{ )                /oxgc) { $slash = 'm//'; return 'eval';              }
    elsif (/\G \b Char::Sjis::eval    \b (?! \s* => )                /oxgc) { $slash = 'm//'; return 'eval Char::Sjis::escape'; }
...
# subroutines of package Char::Esjis
        ...
        elsif ($string =~ /\G \b Char::Sjis::eval       (?= \s* \{ )                /oxgc) { $e_string .= 'eval';              $slash = 'm//'; }
        elsif ($string =~ /\G \b Char::Sjis::eval \b                                /oxgc) { $e_string .= 'eval Char::Sjis::escape'; $slash = 'm//'; }
...
sub e_sub {
    ...
    if ($r_modifier) {
        ...
        # s///gr with multibyte anchoring
            ...
            $sub = sprintf(
                #                              1                                              2   3                                 4   5
                q<CORE::eval{local $Char::Sjis::re_t=%s; local $Char::Sjis::re_a=''; while($Char::Sjis::re_t =~ %s){%s local $^W=0; local $Char::Sjis::re_r=%s; %s$Char::Sjis::re_t="$Char::Sjis::re_a${1}$Char::Sjis::re_r$'"; pos($Char::Sjis::re_t)=length "$Char::Sjis::re_a${1}$Char::Sjis::re_r"; $Char::Sjis::re_a=substr($Char::Sjis::re_t,0,pos($Char::Sjis::re_t)); } return $Char::Sjis::re_t}>,
                ...
                $s_matched,                                                      #  3
                $e_replacement,                                                  #  4
                '$Char::Sjis::re_r=CORE::eval $Char::Sjis::re_r; ' x $e_modifier,            #  5
            );
        }
        ...
        # s///gr without multibyte anchoring
            ...
            $sub = sprintf(
                #                              1                        2   3                                 4   5
                q<CORE::eval{local $Char::Sjis::re_t=%s; while($Char::Sjis::re_t =~ %s){%s local $^W=0; local $Char::Sjis::re_r=%s; %s$Char::Sjis::re_t="$`$Char::Sjis::re_r$'"; pos($Char::Sjis::re_t)=length "$`$Char::Sjis::re_r"; } return $Char::Sjis::re_t}>,
        ...
        # s///r
            ...
            $sub = sprintf(
                #  1     2                3                                 4   5  6                    7
                q<(%s =~ %s) ? CORE::eval{%s local $^W=0; local $Char::Sjis::re_r=%s; %s"%s$Char::Sjis::re_r$'" } : %s>,
    ...
    # without /r
        ...
        # s///g with multibyte anchoring
            ...
            $sub = sprintf(
                ...
                q<CORE::eval{local $Char::Sjis::re_n=0; local $Char::Sjis::re_a=''; while(%s =~ %s){%s local $^W=0; local $Char::Sjis::re_r=%s; %s%s="$Char::Sjis::re_a${1}$Char::Sjis::re_r$'"; pos(%s)=length "$Char::Sjis::re_a${1}$Char::Sjis::re_r"; $Char::Sjis::re_a=substr(%s,0,pos(%s)); $Char::Sjis::re_n++} return %s$Char::Sjis::re_n}>,
...
# (and so on)
        ...
        # s///g without multibyte anchoring
            ...
            $sub = sprintf(
                #                                       1     2   3                                 4   5 6                         7                                                 8
                q<CORE::eval{local $Char::Sjis::re_n=0; while(%s =~ %s){%s local $^W=0; local $Char::Sjis::re_r=%s; %s%s="$`$Char::Sjis::re_r$'"; pos(%s)=length "$`$Char::Sjis::re_r"; $Char::Sjis::re_n++} return %s$Char::Sjis::re_n}>,
        ...
        # s///
            ...
            $sub = sprintf(
                ...
                #  1 2 3                4                                 5   6 7   8
                q<(%s%s%s) ? CORE::eval{%s local $^W=0; local $Char::Sjis::re_r=%s; %s%s="%s$Char::Sjis::re_r$'"; 1 } : undef> :

                #  1 2 3                    4                                 5   6 7   8
                q<(%s%s%s) ? 1 : CORE::eval{%s local $^W=0; local $Char::Sjis::re_r=%s; %s%s="%s$Char::Sjis::re_r$'"; undef }>,
                ...
                $s_matched,                                                      #  4
                $e_replacement,                                                  #  5
                '$Char::Sjis::re_r=CORE::eval $Char::Sjis::re_r; ' x $e_modifier,            #  6
                $variable,                                                       #  7
                $prematch,                                                       #  8
            );
        }
...
This module has run-time routines for use Char::Sjis software automatically, you
do not have to use.
