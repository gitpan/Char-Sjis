...
sub import {
    ...
    if (Char::Esjis::e("$filename.e")) {
        if (exists $ENV{'SJIS_DEBUG'}) {
            ...
            my $mtime_filter = (Char::Esjis::stat(__FILE__     ))[9];
            my $mtime_source = (Char::Esjis::stat($filename    ))[9];
            my $mtime_escape = (Char::Esjis::stat("$filename.e"))[9];
...
# subroutines of package Char::Esjis
    ...
    elsif (/\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) qq \s* (\S) ((?:$qq_char)+?)             (\2) /oxgc) { $slash = 'm//'; return "Char::Esjis::filetest(qw($1)," . e_qq('qq',$2,$4,$3) . ")"; }

    elsif (/\G (-[rwxoRWXOezfdlpSbcugkTB](?:\s+-[rwxoRWXOezfdlpSbcugkTB])+)
                                                         \s* (\') ((?:\\\'|\\\\|$q_char)+?)    (\') /oxgc) { $slash = 'm//'; return "Char::Esjis::filetest(qw($1)," . e_q ('',  $2,$4,$3) . ")"; }
    ...
    elsif (/\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) q  \s* (\S) ((?:\\\2|\\\\|$q_char)+?)    (\2) /oxgc) { $slash = 'm//'; return "Char::Esjis::filetest(qw($1)," . e_q ('q', $2,$4,$3) . ")"; }
    ...
    elsif (/\G (-[rwxoRWXOezfdlpSbcugkTB](?:\s+-[rwxoRWXOezfdlpSbcugkTB])+) \( ((?:$qq_paren)*?) \) /oxgc) { $slash = 'm//'; return "Char::Esjis::filetest(qw($1),$2)"; }
    ...
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ qq \s* (\S) ((?:$qq_char)+?)                (\2) /oxgc) { $slash = 'm//'; return "Char::Esjis::$1(" . e_qq('qq',$2,$4,$3) . ")"; }

    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+    \s* (\') ((?:\\\'|\\\\|$q_char)+?)       (\') /oxgc) { $slash = 'm//'; return "Char::Esjis::$1(" . e_q ('',  $2,$4,$3) . ")"; }
    ...
    elsif (/\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ q  \s* (\S) ((?:\\\2|\\\\|$q_char)+?)       (\2) /oxgc) { $slash = 'm//'; return "Char::Esjis::$1(" . e_q ('q', $2,$4,$3) . ")"; }
...
# subroutines of package Char::Esjis
        ...
        elsif ($string =~ /\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) qq \s* (\S) ((?:$qq_char)+?)             (\2) /oxgc) { $e_string .= "Char::Esjis::filetest(qw($1)," . e_qq('qq',$2,$4,$3) . ")"; $slash = 'm//'; }

        elsif ($string =~ /\G (-[rwxoRWXOezfdlpSbcugkTB](?:\s+-[rwxoRWXOezfdlpSbcugkTB])+)
                                                                        \s* (\') ((?:\\\'|\\\\|$q_char)+?)    (\') /oxgc) { $e_string .= "Char::Esjis::filetest(qw($1)," . e_q ('',  $2,$4,$3) . ")"; $slash = 'm//'; }
        ...
        elsif ($string =~ /\G ((?:-[rwxoRWXOezfdlpSbcugkTB]\s+){2,}) q  \s* (\S) ((?:\\\2|\\\\|$q_char)+?)    (\2) /oxgc) { $e_string .= "Char::Esjis::filetest(qw($1)," . e_q ('q', $2,$4,$3) . ")"; $slash = 'm//'; }
        ...
        elsif ($string =~ /\G (-[rwxoRWXOezfdlpSbcugkTB](?:\s+-[rwxoRWXOezfdlpSbcugkTB])+) \( ((?:$qq_paren)*?) \) /oxgc) { $e_string .= "Char::Esjis::filetest(qw($1),$2)"; $slash = 'm//'; }
        ...
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ qq \s* (\S) ((?:$qq_char)+?)                (\2) /oxgc) { $e_string .= "Char::Esjis::$1(" . e_qq('qq',$2,$4,$3) . ")"; $slash = 'm//'; }

        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+    \s* (\') ((?:\\\'|\\\\|$q_char)+?)       (\') /oxgc) { $e_string .= "Char::Esjis::$1(" . e_q ('',  $2,$4,$3) . ")"; $slash = 'm//'; }
        ...
        elsif ($string =~ /\G -([rwxoRWXOezsfdlpSbcugkTBMAC]) \s+ q  \s* (\S) ((?:\\\2|\\\\|$q_char)+?)       (\2) /oxgc) { $e_string .= "Char::Esjis::$1(" . e_q ('q', $2,$4,$3) . ")"; $slash = 'm//'; }
...
import of Char/Esjis.pm works well.
...
=item * Returns Next Character
  ...
  If you import getc "use Char::Sjis qw(getc);", getc of your script will be rewritten
  in Char::Sjis::getc. Char::Sjis::getc is not compatible with getc of JPerl.
...
=item * Length by ShiftJIS Character
  ...
  of the scalar value $string. If $string is omitted, it returns the Char::Sjis::length
  of $_.
...
=item * Substr by ShiftJIS Character
  ...
  If Perl version 5.14 or later, you can use the Char::Sjis::substr() subroutine as an
...
=item * Rindex by ShiftJIS Character
  ...
  This subroutine works just like Char::Sjis::index except that it returns the character
...
=item * Filename Globbing
  ...
  This operator is implemented via the Char::Esjis::glob() subroutine. See Char::Esjis::glob
  of Char/Esjis.pm for details.
...
=head1 Un-Escaping bytes::* Subroutines (Char/Sjis.pm provides)

Char/Sjis.pm removes 'bytes::' at head of subroutine name.
...
If Perl version is older than 5.14, Char::Sjis::substr differs from CORE::substr, and
