...
=item * Only Char/Sjis.pm and Char/Esjis.pm, other modules are unnecessary
...
Char/Sjis.pm remove 'bytes::' at head of function name.
...
Char/Sjis.pm remove '\' at head of alphanumeric regexp metasymbols \N, \p, \P
...
oriented function. See 'CHARACTER ORIENTED FUNCTIONS'.
  ...
  index       Char::Sjis::index
  rindex      Char::Sjis::rindex
  ---------------------------------
