...
Insert 'Char::Esjis::' instead of '-' of operator.
  ...
  --------------------------------------------------------------------------
  -r       Char::Esjis::r   File is readable by effective uid/gid
  -w       Char::Esjis::w   File is writable by effective uid/gid
  -x       Char::Esjis::x   File is executable by effective uid/gid
  -o       Char::Esjis::o   File is owned by effective uid
  -R       Char::Esjis::R   File is readable by real uid/gid
  -W       Char::Esjis::W   File is writable by real uid/gid
  -X       Char::Esjis::X   File is executable by real uid/gid
  -O       Char::Esjis::O   File is owned by real uid
  -e       Char::Esjis::e   File exists
  -z       Char::Esjis::z   File has zero size
  -f       Char::Esjis::f   File is a plain file
  -d       Char::Esjis::d   File is a directory
  -l       Char::Esjis::l   File is a symbolic link
  -p       Char::Esjis::p   File is a named pipe (FIFO)
  -S       Char::Esjis::S   File is a socket
  -b       Char::Esjis::b   File is a block special file
  -c       Char::Esjis::c   File is a character special file
  -t       -t         Filehandle is opened to a tty
  -u       Char::Esjis::u   File has setuid bit set
  -g       Char::Esjis::g   File has setgid bit set
  -k       Char::Esjis::k   File has sticky bit set
  -T       Char::Esjis::T   File is a text file
  -B       Char::Esjis::B   File is a binary file (opposite of -T)
  -s       Char::Esjis::s   File has nonzero size (returns size in bytes)
  -M       Char::Esjis::M   Age of file (at startup) in days since modification
  -A       Char::Esjis::A   Age of file (at startup) in days since last access
  -C       Char::Esjis::C   Age of file (at startup) in days since inode change
  --------------------------------------------------------------------------
