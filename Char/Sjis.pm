...
impossible. Char::Sjis software is Perl program designed to make the "easy jobs easy".
...
Definitions in Char/Esjis.pm.
  ...
  ${Char::Esjis::not_space}      qr{(?:[\x81-\x9F\xE0-\xFC][\x00-\xFF]|[^\x81-\x9F\xE0-\xFC\x09\x0A\x0B\x0C\x0D\x20])}
...
Contrasting is Encode module and describing "use Char::Sjis;" on this software,
