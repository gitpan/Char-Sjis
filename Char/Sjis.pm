...
sub Char::Sjis::escape_script {
    ...
    if (/^ use Char::Esjis(?:\s+[0-9\.]*)?\s*; $/oxms) {
        ...
        # use Char::Sjis version qw(ord reverse);
        $function_ord     = 'ord';
        $function_ord_    = 'ord';
...
=head1 SYNOPSIS
  ...
  use Char::Sjis qw(ord reverse); --- demand enhanced feature of ord and reverse
  use Char::Sjis ver.sion qw(ord reverse);
  use Char::Sjis ver.sion.0 qw(ord reverse);
