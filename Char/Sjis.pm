...
my $m_matched   = '';
my $s_matched   = '';
$m_matched   = q{@Char::Esjis::m_matched};
...
sub character_class {
    ...
    if ($char eq '.') {
        if ($modifier =~ /s/) {
            return '(?:[\x81-\x9F\xE0-\xFC][\x00-\xFF]|[^\x81-\x9F\xE0-\xFC])';
        }
        else {
            return '(?:[\x81-\x9F\xE0-\xFC][\x00-\xFF]|[^\x81-\x9F\xE0-\xFC\x0A])';
        }
    }
    else {
...
=item * Handles Raw ShiftJIS, No UTF8 flag like JPerl
...
The character classes are redefined as follows to backward compatibility.
  ...
  ---------------------------------------------------------------------------
   .            (?:[\x81-\x9F\xE0-\xFC][\x00-\xFF]|[^\x81-\x9F\xE0-\xFC\x0A])
                (?:[\x81-\x9F\xE0-\xFC][\x00-\xFF]|[^\x81-\x9F\xE0-\xFC])     (/s modifier)
  \d            [0-9]
...
functions.
  ...
  index       Char::Esjis::index
  rindex      Char::Esjis::rindex
  lc          Char::Esjis::lc
  lcfirst     Char::Esjis::lcfirst
  uc          Char::Esjis::uc
  ucfirst     Char::Esjis::ucfirst
  chr         Char::Esjis::chr
  glob        Char::Esjis::glob
  lstat       Char::Esjis::lstat
  opendir     Char::Esjis::opendir
  stat        Char::Esjis::stat
  unlink      Char::Esjis::unlink
  chdir       Char::Esjis::chdir
  do          Char::Esjis::do
  require     Char::Esjis::require
  ---------------------------------
...
=item * Reverse List Or String
  ...
  %barfoo = Char::Sjis::reverse(%foobar);
...
=item * Special Variables $` And $& Doesn't Function
  ...
  is escaped to
    'AAABBBCCC' =~ /\G(?:[\x81-\x9F\xE0-\xFC][\x00-\xFF]|[^\x81-\x9F\xE0-\xFC])*?(?:BBB)@Char::Esjis::m_matched/;
