...
sub e_use_noimport {
    ...
    for my $realfilename (_realfilename($expr)) {
        ...
        if (CORE::open($fh, $realfilename)) {
            ...
            if ($script =~ m/^ \s* use \s+ Char::Sjis \s* ([^;]*) ; \s* \n? $/oxms) {
...
=head1 Perl5.6 Emulation On perl5.005
  ...
  --------------------------------------------------------------------
  Before          After                  in BEGIN { } of Char/Esjis.pm
  --------------------------------------------------------------------
  binmode(...);   Char::Esjis::binmode(...);   *CORE::GLOBAL::binmode = ...
  open(...);      Char::Esjis::open(...);      *CORE::GLOBAL::open    = ...
  --------------------------------------------------------------------
...
=item * binmode (Perl5.6 emulation on perl5.005)
  ...
  * two arguments
  ...
  If you are using perl5.005 other than MacPerl, Char::Sjis software emulate perl5.6's
...
=item * open (Perl5.6 emulation on perl5.005)
  ...
  * three arguments
  ...
  If you are using perl5.005, Char::Sjis software emulate perl5.6's open function.
  ...
  open(FH, "<:crlf:encoding(Char::Sjis)", $path) or die "can't open $path: $!";
